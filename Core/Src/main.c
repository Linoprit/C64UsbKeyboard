...
int main(void)
{
  ...
  applicationTaskHandle = osThreadNew(StartApplicationTask, NULL, &applicationTask_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, Row8_Pin|Row6_Pin|Row5_Pin|Row4_Pin
                          |Row3_Pin|Row2_Pin|Row1_Pin|Row0_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : ColA_Pin ColB_Pin ColC_Pin ColD_Pin
                           ColE_Pin ColF_Pin ColG_Pin ColH_Pin */
  GPIO_InitStruct.Pin = ColA_Pin|ColB_Pin|ColC_Pin|ColD_Pin
                          |ColE_Pin|ColF_Pin|ColG_Pin|ColH_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : ColI_Pin */
  GPIO_InitStruct.Pin = ColI_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(ColI_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : Row8_Pin Row6_Pin Row5_Pin Row4_Pin
                           Row3_Pin Row2_Pin Row1_Pin Row0_Pin */
  GPIO_InitStruct.Pin = Row8_Pin|Row6_Pin|Row5_Pin|Row4_Pin
                          |Row3_Pin|Row2_Pin|Row1_Pin|Row0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : Row7_Pin */
  GPIO_InitStruct.Pin = Row7_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(Row7_GPIO_Port, &GPIO_InitStruct);
